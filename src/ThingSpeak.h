    ...
    class ThingSpeakClass
    {
      public:
        ...
        */
        String readRaw(unsigned long channelNumber, String suffixURL, const char * readAPIKey)
        {
            ...
            if (this->nextReadTimezone.length() > 0) {
                if (readURL.indexOf('?', 0) == -1) {
                    readURL.concat("?");
                } else {
                    readURL.concat("&");
                }

                readURL.concat("timezone=");
                readURL.concat(this->nextReadTimezone);
            }
        ...
        */
        ...
        /*
        Function: setReadTimezone
        
        Summary:
        Set the timezone to use for the next reading.
        
        Parameters:
        timezone - Desired timezone to be used with the next read as a char. The timezone must be one of these: https://de.mathworks.com/help/thingspeak/time-zones-reference.html
        ...
        */
        ...
        Parameters:
        timezone - Desired timezone to be used with the next read as a String. The timezone must be one of these: https://de.mathworks.com/help/thingspeak/time-zones-reference.html
        ...
        */
        ...
        /*
        Function: resetReadTimezone
        
        Summary:
        Resets the timezone to use for the next reading.
